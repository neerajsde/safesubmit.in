...
import { FaArrowRightLong, FaGlobe, FaUserTie, FaCalendarCheck, FaCommentDots } from "react-icons/fa6";
...
export default function Home() {
  return (
    <div className="w-full p-6 md:p-10 flex flex-col items-center gap-10 bg-gray-50">

      <HomeHero/>

      {/* Use Case Section */}
      <section className="w-full flex flex-col border shadow-sm bg-white py-6 rounded-2xl md:flex-row items-center justify-center gap-12">
        <Image
          src={FormImage}
          alt="Where You Use"
          width={250}
        ...
        />
        <div className="md:max-w-lg text-left space-y-5">
          <h2 className="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
